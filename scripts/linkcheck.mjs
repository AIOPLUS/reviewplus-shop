 ...
 * Houdt rekening met SHOP_BASE_PATH en met build.format "file" (/aanvragen → aanvragen.html).
...
const rawBase = process.env.SHOP_BASE_PATH || '/';
...
if (external) {
  const own = (process.env.SITE_URL || 'https://shop.reviewplus.io').replace(/\/+$/, '');
